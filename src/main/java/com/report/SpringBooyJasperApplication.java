...
public class SpringBooyJasperApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringBooyJasperApplication.class, args);
	}
	...
	CommandLineRunner init(){
		return args -> {
			...
			parameters.put("voucher_id", "0000004458");
			...
			System.out.printf("Report created succesfully");
		};
